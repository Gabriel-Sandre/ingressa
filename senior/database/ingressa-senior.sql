...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260917204058_SeniorFilaEIdempotencia') THEN
    ALTER TABLE "Eventos" ADD "FilaVirtual" boolean NOT NULL DEFAULT FALSE;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260917204058_SeniorFilaEIdempotencia') THEN
    CREATE TABLE "RequisicoesIdempotentes" (
        "Id" bigint GENERATED BY DEFAULT AS IDENTITY,
        "UsuarioId" integer NOT NULL,
        "Chave" character varying(100) NOT NULL,
        "Rota" character varying(200) NOT NULL,
        "HashDaRequisicao" character varying(64) NOT NULL,
        "StatusHttp" integer,
        "Resposta" jsonb,
        "Local" character varying(300),
        "CriadaEm" timestamp with time zone NOT NULL,
        "ConcluidaEm" timestamp with time zone,
        CONSTRAINT "PK_RequisicoesIdempotentes" PRIMARY KEY ("Id")
    );
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260917204058_SeniorFilaEIdempotencia') THEN
    CREATE INDEX "IX_RequisicoesIdempotentes_CriadaEm" ON "RequisicoesIdempotentes" ("CriadaEm");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260917204058_SeniorFilaEIdempotencia') THEN
    CREATE UNIQUE INDEX "IX_RequisicoesIdempotentes_UsuarioId_Chave" ON "RequisicoesIdempotentes" ("UsuarioId", "Chave");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260917204058_SeniorFilaEIdempotencia') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260917204058_SeniorFilaEIdempotencia', '10.0.11');
    END IF;
END $EF$;
COMMIT;
